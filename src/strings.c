...
const u8 gText_BirchOptionsActive[] = _("(x)");
const u8 gText_BirchOptionsNotActive[] = _("()");
const u8 gText_BirchOptionsResetOnWhiteout[] = _("{DYNAMIC 0}Whiteout Clause");
const u8 gText_BirchNormalMode[] = _("{DYNAMIC 0}Normal");
