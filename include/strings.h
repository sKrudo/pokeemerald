...
extern const u8 gText_BirchOptionsActive[];
extern const u8 gText_BirchOptionsNotActive[];
extern const u8 gText_BirchOptionsResetOnWhiteout[];
...
extern const u8 gText_ReviveNuzlocke[];
extern const u8 gText_NuzlockeCantCatchRoute[];
